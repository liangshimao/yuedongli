...
<div class="search-nav">
    <form class="form-inline" action="<?= Url::toRoute('/youyue/logo/index') ?>" method="get">
        ...
        <tr>
            ...
            <td style="vertical-align: middle;">
                <a class="btn btn-warning buttonbtn btn-info button"
                   href="javascript:window.parent.edit(1,'修改LOGO信息','<?php echo Url::toRoute(['/youyue/logo/edit', 'id' => $info->id]); ?>', 600, 420)"><i
...
<script type="text/javascript">
    ...
    function add()
    {
        ...
        if(count >= 1)
        {
            ...
            omnipotent('edit','<?=Url::toRoute('/youyue/logo/add')?>', '添加LOGO图', 600, 420, 0);
        }
