...
<div class="pad_10">
    <div class="common-form">
        <form name="myform" action="<?php echo Url::toRoute(['/youyue/logo/edit','id'=>$model->id]); ?>" method="post" id="myform">
            <table width="100%" class="table_form contentWrap">
                <tr>
                    <th width="100">名  称：</th>
                    <td><input type="text" name="logo[name]" value="<?=$model->name;?>" class="form-control-table width-160" id="name" style="display: inline" ></td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="logo[img_url]" value="<?=$model->img_url?>" id="thumb_hidden">
                        <input type="file" id="thumb_file" name="thumb_file" style="display: none;">
                    </td>
                </tr>
                <tr>
                    <th width="100">描 述：</th>
                    <td><textarea class="inputStyle moretxt width-160" id="desc" placeholder="请输入描述信息" name="logo[desc]" style="display: inline; width: 350px; height: 80px;" maxlength="50"><?=$model->desc;?></textarea></td>
                </tr>
            </table>
