...
?>
<form name="myform" id="myform" action="<?=Url::toRoute(['/youyue/duty/edit','id' => $model->id]) ?>" method="post">
    <div class="common-form">
        <table width="100%" class="table_form contentWrap">
            ...
            <tr>
                <th width="80">职位名称：</th>
                <td>
                    <input class="form-control menu_source" value="<?=$model->name?>" style="width:200px" placeholder="请输入职位名称" name="name">
