...
<div class="search-nav">
    <form class="form-inline" action="<?= Url::toRoute('/youyue/companyinfo/index') ?>" method="get">
        ...
        <div class="form-group">
            <input type="hidden" id="bannerCount" value="<?php echo $infoCount;?>">
        ...
        <tr>
            ...
            <td style="vertical-align: middle;">
                <a class="btn btn-warning buttonbtn btn-info button"
                   href="javascript:window.parent.edit(1,'修改基本信息','<?php echo Url::toRoute(['/youyue/info/edit', 'id' => $info->id]); ?>', 600, 420)"><i
...
<script type="text/javascript">
    ...
    function add()
    {
        ...
        if(count >= 1)
        {
            artAlert("公司基本信息只能添加1张");
        }else{
            omnipotent('edit','<?=Url::toRoute('/youyue/info/add')?>', '添加公司基本信息', 600, 420, 0);
        }
    }
